...
public class DslFilesTest {
    ...
    public void runCreate02Resource() throws FileNotFoundException, DslProcessorException {
        ...
        Repository repo1 = new MutableRepository(world.getRepository().getTrie().getStore(), world.getRepository().getTrie().getStore().retrieve(top1.getStateRoot()));

        // Creates a new view of the repository, standing on top2 state
        Repository repo2 = new MutableRepository(world.getRepository().getTrie().getStore(), world.getRepository().getTrie().getStore().retrieve(top2.getStateRoot()));
