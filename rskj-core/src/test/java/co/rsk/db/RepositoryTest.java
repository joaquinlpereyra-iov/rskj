...
public class RepositoryTest {
    ...
    public void testMultiThread() throws InterruptedException {
        ...
        Repository snap = new MutableRepository(trieStore.retrieve(repository.getRoot()).getStore(), trieStore.retrieve(repository.getRoot()));
        new Thread(() -> {
            try {
                int cnt = 1;
                while(true) {
    ...
    public void testCode() {
        ...
        Repository repository2 = new MutableRepository(trieStore.retrieve(prevRoot).getStore(), trieStore.retrieve(prevRoot));
        // Now try to get the size
